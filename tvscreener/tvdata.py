...
stock = {
    ...
    'columns': {'earnings_per_share_basic_ttm': 'Basic EPS (TTM)',
                'change': 'Change %',
                'change_abs': 'Change',
                ...
                'average_volume_10d_calc': 'Average Volume (10 day)',
                'average_volume_30d_calc': 'Average Volume (30 day)',
                'average_volume_60d_calc': 'Average Volume (60 day)',
                'average_volume_90d_calc': 'Average Volume (90 day)',
...
crypto = {
    'columns': {'change': 'Change %',
                ...
                'Recommend.All': 'Technical Rating',
                'volume': 'Volume',
                '24h_vol_change|5': 'Volume 24h Change %',
                '24h_vol|5': 'Volume 24h in USD',
                'High.1M': '1-Month High',
                'Low.1M': '1-Month Low',
                'High.3M': '3-Month High',
                'Low.3M': '3-Month Low',
                ...
                'Aroon.Up': 'Aroon Up (14)',
                'ask': 'Ask',
                'total_shares_outstanding': 'Available Coins',
                'ADR': 'Average Day Range (14)',
                'ADX': 'Average Directional Index (14)',
                'ATR': 'Average True Range (14)',
                'average_volume_10d_calc': 'Average Volume (10 day)',
                ...
                'EMA100': 'Exponential Moving Average (100)',
                'EMA200': 'Exponential Moving Average (200)',
                'market_cap_diluted_calc': 'Fully Diluted Market Cap',
                'gap': 'Gap %',
                'HullMA9': 'Hull Moving Average (9)',
                'Ichimoku.BLine': 'Ichimoku Base Line (9, 26, 52, 26)',
                'Ichimoku.CLine': 'Ichimoku Conversion Line (9, 26, 52, 26)',
                ...
                'Stoch.RSI.K': 'Stochastic RSI Fast (3, 3, 14, 14)',
                'Stoch.RSI.D': 'Stochastic RSI Slow (3, 3, 14, 14)',
                'total_shares_diluted': 'Total Coins',
                'total_value_traded': 'Traded Volume',
                'UO': 'Ultimate Oscillator (7, 14, 28)',
                'Volatility.D': 'Volatility',
                'Volatility.M': 'Volatility Month',
                'Volatility.W': 'Volatility Week',
